...
const Login = () => {
  return (
    <div className="relative w-full min-h-screen">
      ...
      <Link to="/signin" className="absolute top-6 right-10 z-40 bg-red-600 text-white px-4 py-2 rounded-md hover:bg-red-700 cursor-pointer inline-block text-center">
        Sign In
      </Link>
      ...
      <div className="relative z-20 flex flex-col items-center justify-center min-h-screen text-white px-6">
        ...
        <div className="flex gap-3 w-full max-w-3xl">
          ...
          />
          <Link to="/signup" className="bg-red-600 text-white px-10 py-5 rounded text-xl font-semibold hover:bg-red-700 flex items-center gap-2">
