    ...
    <div className="relative w-full h-screen overflow-y-auto bg-black">
      ...
      <div className="absolute top-5 right-48 z-40">
        <button
          ...
          className="group flex items-center gap-2.5 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white text-sm font-semibold py-2.5 px-5 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 ease-in-out hover:scale-105 active:scale-95 border border-red-500/20"
        >
          <svg
      ...
      <div className="absolute top-5 right-8 z-40">
        <div className="relative group">
          <div className="w-10 h-10 rounded-md cursor-pointer overflow-hidden transition-all duration-300 ease-in-out hover:scale-110 active:scale-95 hover:shadow-lg hover:shadow-red-500/30 border-2 border-transparent hover:border-red-500/50">
            <img
              src={profile_img_red}
              alt="Profile"
          ...
          <div className="absolute top-14 right-0 w-64 bg-black bg-opacity-95 border border-gray-700 rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 ease-in-out">
            ...
            <div className="border-t border-gray-700">
              <div
                ...
                className="px-4 py-3 text-white text-sm text-center hover:bg-gray-800 cursor-pointer"
              >
                Sign out of Netflix
              </div>
            </div>
