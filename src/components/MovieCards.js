...
const MovieCards = ({ posterPath, title = "Movie poster" }) => {
  if (!posterPath) {
    return (
      <div className="w-44 h-64 flex-shrink-0 transition-all duration-300 ease-in-out">
        <div className="w-full h-full rounded-md bg-gradient-to-b from-gray-700 to-gray-900 shadow-lg" />
